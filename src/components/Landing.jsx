    ...
    <div className="container8">
      <header className="header3">
        ...
        <nav className="nav-buttons">
          <button className="btn btn-outline" onClick={gotoLogin}>Sign Up</button>
      ...
      <main className="hero">
        ...
        <p className="subtitle">
          Save yourself time and stress with<br />
          personalized learning on the best content!
        </p>

        <button className="btn btn-primary" onClick={gotoDocumenttitle}>Find your exam</button>
      </main>
      ...
      <p className="subtitle">Join thousands of students already learning with us</p>
          ...
          <div key={testimonial.id} className="testimonial-card">
            <div className="stars">
              {[...Array(testimonial.rating)].map((_, index) => (
                <span7 key={index} className="star">★</span7>
              ))}
            </div>
